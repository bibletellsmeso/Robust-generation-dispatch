...
class Photovoltaic:
    def __init__(self):
        ...
        self.Weather_Forecast = np.genfromtxt('/Users/PSL/OneDrive/Programing/Python/Robust generation dispatch/data/Hawaii weather.csv', delimiter=',', skip_header=1, dtype=np.float32)
        self.real_PV = np.loadtxt("/Users/PSL/OneDrive/Programing/Python/Robust generation dispatch/data/PV_for_scheduling.txt")
