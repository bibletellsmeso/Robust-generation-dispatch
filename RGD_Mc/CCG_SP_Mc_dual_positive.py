...
class CCG_SP():
    ...
    def create_model(self):
        ...
        phi_pos = model.addVars(self.nb_periods, lb=0, ub=GRB.INFINITY, vtype=GRB.CONTINUOUS, obj=0, name="phi_pos")
        phi_neg = model.addVars(self.nb_periods, lb=0, ub=GRB.INFINITY, vtype=GRB.CONTINUOUS, obj=0, name="phi_neg")
        phi_chg = model.addVars(self.nb_periods, lb=0, ub=GRB.INFINITY, vtype=GRB.CONTINUOUS, obj=0, name="phi_chg")
        phi_dis = model.addVars(self.nb_periods, lb=0, ub=GRB.INFINITY, vtype=GRB.CONTINUOUS, obj=0, name="phi_dis")
        ...
        phi_Smin = model.addVars(self.nb_periods, lb=0, ub=GRB.INFINITY, vtype=GRB.CONTINUOUS, obj=0, name="phi_Smin")
        phi_Smax = model.addVars(self.nb_periods, lb=0, ub=GRB.INFINITY, vtype=GRB.CONTINUOUS, obj=0, name="phi_Smax")
        ...
        phi_cut = model.addVars(self.nb_periods, lb=0, ub=GRB.INFINITY, vtype=GRB.CONTINUOUS, obj=0, name="phi_cut")
        ...
        phi_add = model.addVars(self.nb_periods, lb=0, ub=GRB.INFINITY, vtype=GRB.CONTINUOUS, obj=0, name="phi_add")
